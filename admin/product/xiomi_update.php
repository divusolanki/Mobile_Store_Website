...
if(isset($_POST['update_product'])){
    ...
    $query = "UPDATE `xiomi` SET name='$phonename', storage='$storage', ram='$ram', processor='$processor', launch_date='$launch_date', camera='$camera', display='$display', battery='$battery', price='$price' WHERE id='$ids' ";
...
<form method="POST" enctype="multipart/form-data">
        ...
        $query = "select * from `xiomi` where id=$ids";
        $query_run = mysqli_query($con, $query);
    ...
    <div class="back-btn" style="position:absolute;top:25px;right:50px;font-size:35px;cursor: pointer;">
        <a href="../xiomi.php">&#10006</a>
    </div>

        <h3 style="margin-top: 30px;text-align:center;">Update Xiomi Product</h3>
