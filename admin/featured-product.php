...
if(isset($_POST['submit'])){
    ...
    if($fileerror == 0){
        $destfile = 'images/featured-product/'.$filename;
        move_uploaded_file($filepath, $destfile);

        $sql = "INSERT INTO `featured-products`(`image`, `name`, `storage`, `ram`, `processor`) VALUES ('$destfile','$phonename','$storage','$ram','$processor')";
...
<div class="small-container product-detail">
    <table>
        ...
        ?>
            ...
            <td><a href="featured-product/update.php?id=<?php echo $res['id'] ?>"><button class="btn btn-primary" style="width: 80px;margin-top:25px;">Update</button></a>
            <a href="featured-product/delete.php?id=<?php echo $res['id'] ?>"><button class="btn btn-danger" style="width: 80px;margin-top:25px;">Delete</button></td></a>
        </tr>
        <?php }?>
        </tbody>
