...
if(isset($_POST['update_product'])){
    ...
    $query = "UPDATE `oneplus` SET name='$phonename', storage='$storage', ram='$ram', processor='$processor', launch_date='$launch_date', camera='$camera', display='$display', battery='$battery', price='$price' WHERE id='$ids' ";
...
<form method="POST" enctype="multipart/form-data">
    ...
    <div class="back-btn" style="position:absolute;top:25px;right:50px;font-size:35px;cursor: pointer;">
        ...
        <h3 style="margin-top: 30px;text-align:center;">Update OnePlus Product</h3>
