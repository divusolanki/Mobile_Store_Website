...
if(isset($_POST['submit'])){
    ...
    if($fileerror == 0){
        $destfile = 'images/oppo/'.$filename;
        move_uploaded_file($filepath, $destfile);

        $sql = "INSERT INTO `oppo`(`image`, `name`, `storage`, `ram`, `processor`, `launch_date`, `camera`, `display`, `battery`,`price`) VALUES ('$destfile','$phonename','$storage','$ram','$processor','$launch_date','$camera','$display','$battery','$price')";
        // echo $sql;
    }
...
<form method="POST" enctype="multipart/form-data">
    <div class="close-btn" onclick="closePopup()" style="position:absolute;top:50px;right:30px;font-size:25px;cursor: pointer;">
        ...
        <h3 style="margin-left: 15px;">Add Oppo Product</h3>
...
<div class="small-container product-detail">
    <table>
        ...
        ?>
            ...
            <td><a href="product/oppo_update.php?id=<?php echo $res['id'] ?>"><button class="btn btn-primary" style="width: 80px;margin-top:25px;">Update</button></a>
            <a href="product/oppo_delete.php?id=<?php echo $res['id'] ?>"><button class="btn btn-danger" style="width: 80px;margin-top:25px;">Delete</button></td></a>
        </tr>
        <?php }?>
        </tbody>
    </table>
