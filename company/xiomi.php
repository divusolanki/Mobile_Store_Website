...
<head>
    ...
    <title>Xiomi | Mobile Phones</title>
    <style>
        .xiomi .row{
...
<div class="xiomi">    
<h3 style="text-align:center;font-size:40px;">Xiomi</h3>
<hr style="margin-top:-10px;width:105px;margin-left:46%;border: 2px solid coral;">
    ...
    <?php
        ...
        <img src="../admin/<?php echo $res['image']; ?>" width="350" height="150" style="margin-top:5px;margin-left:7px;">
            ...
            <a href="xiomi_cart.php?image=<?php echo $res['image']?>&&name=<?php echo $res['name'] ?>&&price=<?php echo $res['price'] ?>" class="btn">Add to Cart</a>
            <a href="xiomi_view.php?id=<?php echo $res['id'] ?>" style="text-decoration:none;color:black;" onclick="openPopup()"><i class="far fa-eye"></i></a>
        </div>
        <?php } ?>
    </div>
</div>
