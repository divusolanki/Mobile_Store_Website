...
if(isset($_POST['update_product'])){
    ...
    $query = "UPDATE `product` SET name='$phonename', storage='$storage', ram='$ram', processor='$processor' WHERE id='$ids' ";
...
<form method="POST" enctype="multipart/form-data">
    ...
    <div class="back-btn" style="position:absolute;top:25px;right:50px;font-size:35px;cursor: pointer;">
        <a href="../product.php">&#10006</a>
    </div>

        <h3 style="margin-top: 30px;text-align:center;">Update Product</h3>
